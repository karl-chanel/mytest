        ...
        while (true) {
            ...
            while (it.hasNext()) {
                ...
                if (selectionKey.isReadable()) {
                    ...
                    System.out.println("from 客户端：" + socketChannel.getRemoteAddress() + "           " + new String(buffer.array()));
                    buffer.clear();
                    String s = "hello from server your ip :  visit count" +  count+"    " + socketChannel.getRemoteAddress() + "\n";
